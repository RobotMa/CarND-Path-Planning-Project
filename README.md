...
Each function is documented with input/output/description and the state machine part is written in a way that one can infer he state definition from the `Lane` and `LaneState` data structure.
